                ...
                <div class="row">
                    ...
                    <div class="col-md-8 col-lg-7 offset-lg-1">
                        <form class="shadow-sm">
                            <div class="form-body">
                                <p class="form-title mb-4"><strong>Donation</strong></p>
                                <div class="row justify-content-center mb-4">
                                    <div class="col-xl-6 col-lg-7 col-sm-8  col-11">
                                        <select class="form-select rounded-0" id="temple" aria-label="Default select example">
                                            <option disabled selected hidden>Select Temple</option>
                                            <option value="1">Pashupatinath</option>
                                            <option value="2">Manakamana</option>
                                        </select>
                                    </div>
                                                                     
                                </div>
                                <div class="row justify-content-center mb-4 " style="display: none;" id="Pashupatinath">
                                    <div class="col-xl-6 col-lg-7 col-sm-8  col-11">
                                        
                                        <select class="form-select rounded-0" aria-label="Default select example">
                                            <option disabled selected hidden>Cause / Project</option>
                                            <option value="1">Wall construction around temple</option>
                                            <option value="2">Bagmati clean-up campaign</option>   
                                        </select>
                                        
                                    </div>                                    
                                </div>
                                <div class="row justify-content-center mb-4 " style="display: none;" id="Manakamana">
                                    <div class="col-xl-6 col-lg-7 col-sm-8  col-11">
                                        
                                        <select class="form-select rounded-0" aria-label="Default select example">
                                            <option disabled selected hidden>Cause / Project</option>
                                            <option value="1">Help for the needy</option>
                                            <option value="2">Temple area clean-up</option>   
                                        </select>
                                ...
                                <div class="row justify-content-center mb-4">
                                    <div class="col-xl-6 col-lg-7 col-sm-8  col-11">
                                        <input type="text" class="form-control rounded-0" id="organization" placeholder="Organization Name (optional)">
                                    </div>                                    
                                </div>
                                <div class="row justify-content-center mb-4">
                                    <div class="col-xl-6 col-lg-7 col-sm-8  col-11">
                                ...
                                <div class="row justify-content-center mb-4">
                                    <div class="col-xl-6 col-lg-7 col-sm-8  col-11">
                                        <input type="text" class="form-control rounded-0" id="amount" placeholder="Amount">
                                    </div>                                    
                                </div>
                                
                                <div class="row justify-content-center mb-4">
                                    <div class="col-xl-6 col-lg-7 col-sm-8  col-11">
                                        <img src="assets/img/Screenshot (33).png" class="img-fluid">
                                    </div>                                    
                                </div>
                                
                                <div class="row justify-content-center mb-4">
                                    <div class="col-xl-6 col-lg-7 col-sm-8  col-11">
                                        <button type="submit" class="btn btn-primary" style="width: 100%;"><strong>Submit</strong></button>
                                    </div>                                    
                                </div>
                            </div>
                        </form>
