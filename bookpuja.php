            ...
            <div class="container-xxl">
                <div class="row" style="margin-top:45px;">
                    <div class=" col-md-7 col-xl-7 col-12 ">
                        ...
                        <div class="row title">
                            <div class="col">
                                <h1><strong>Panchamrit Puja</strong></h1>
                                <p>Pooja of the Shiva Linga is performed with the prescribed articles like flowers, coconut
                                    etc., Shivopasana mantra is recited and archana is performed by reciting the 108
                                    Namavali (names) of Lord Shiva. The Shodasa Upacharas are performed.</p>
                            </div>
                        </div>
                    </div>
                    <div class=" col-md-3 col-xl-2 col-sm-4 col-7 order-md-first">
                        <div class="image" style="height: 154px;"><img src="assets/img/Image-11.png" class="img-fluid" alt=""></div>
                    </div>

                    <div class=" col-md-2 col-xl-2 col-sm-4 col-5 offset-xl-1 order-md-last">
                        <span style="font-size: 24px;">USD 1,500</span><br>
                        per hour
                    </div>
                </div>
                <div class="row booking">
                    <div class="title"><h1><strong>Booking</strong></h1></div>
                </div>
                <div class="row">
                    <div class="col-md-7">
                        <div class="calender mb-3" style="height: 610px; background-color: white;">calendar</div>
                    </div>
                    <div class="col-lg-4 col-md-5 offset-lg-1">
                        <form class="row justify-content-center">
                            ...
                            <div class="col-12">
                                <input type="text" class="form-control rounded-0" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" placeholder="Repeated times">
                            </div>
                            <div class="col-12">
                                <input type="text" class="form-control rounded-0" id="exampleInputEmail1"
