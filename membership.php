        ...
        <div class="content">
            <div class="container-xxl">
                ...
                <div class="title">
                    <div class="row">
                        <div class="col-12">
                            <span class="float-start"><strong>Membership</strong></span>
                        </div>
                        <div class="col-12">
                            <hr>
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="card align-items-center shadow-sm rounded-0 h-100">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p>-Prasads from temples will be delivered to home</p>
                                <p>-Can be opened on 4 devices at a time.</p>
                                <p>-20% cashback on every shopped items.</p>
                                <p>-15% cashback on further bookings of pujas and complimentary 1 puja if done 7 pujas (within limit of 2500 dollar)</p>
                                <p>-Assistance will be provided during temple visit.</p>
