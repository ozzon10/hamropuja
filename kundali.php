                    ...
                    <div class="col-md-5">
                        ...
                        <div class="col-md-10 col-lg-9">
                            <form class="row justify-content-center">
                                ...
                                <div class="mb-4 col-sm-9 col-md-12">
                                    <input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" class="form-control rounded-0" placeholder="Date of Birth">
                                </div>
                                <div class="mb-4 col-sm-9 col-md-12">
                                    <input type="text" class="form-control rounded-0" placeholder="Phone Number">
                                </div>
                                <div class="col-sm-9 col-md-12">
                                    <button type="submit" class="btn btn-primary" style="width: 100%;"><strong>Book Now</strong></button>
                                </div>
                            </form>
                        </div>
                    </div>
